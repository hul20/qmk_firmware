...
/* ==========================================================================
 * KEYMAP LAYOUT - 60% ANSI (61 Keys)
 * 
 * ROW0: ESC,  1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   -,   =,  BSPC
 * ROW1: TAB,  Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   [,   ],   \
 * ROW2: CAPS, A,   S,   D,   F,   G,   H,   J,   K,   L,   ;,   ',  ENTER
 * ROW3: LSFT, Z,   X,   C,   V,   B,   N,   M,   ,,   .,   /,  RSFT
 * ROW4: LCTL, LGUI, LALT,        SPACE,        RALT, FN, MENU, RCTL
 * ========================================================================== */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_60_ansi(
        ...
        _______,          KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, _______, _______, KC_END,  KC_PGDN,          _______,
